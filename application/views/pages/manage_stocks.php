                    ...
                    <div class="border-0 mb-4">
                        <div class="card-header py-3 no-bg bg-transparent d-flex align-items-center px-0 justify-content-between border-bottom flex-wrap">
                            ...
                            <div class="col-auto d-flex w-sm-100">
                                <button type="button" class="btn btn-dark btn-set-task w-sm-100 addStock" data-bs-toggle="modal" data-bs-target="#stockadd" data-id="<?=date('YmdHis');?>"><i class="icofont-plus-circle me-2 fs-6"></i>Add Stock</button>
                            </div>
                        </div>
                    </div>
                </div> <!-- Row end  -->
                                    ...
                                    <?php
                                        ...
                                        foreach($stocks as $item){ 
                                            ...
                                            ?>  
                                                ...
                                                <!-- <a href="<?=base_url('delete_stocks/'.$item['id']);?>" class='btn btn-sm btn-outline-danger' onclick="return confirm('Are you sure you want to delete this item?'); return false;"><i class='icofont-ui-delete'></i></a> -->
                                                <?php
                                            echo "</td>";
                                            echo "</tr>";
                                            $x++;

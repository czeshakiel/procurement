        ...
        <div class="header">
            <nav class="navbar py-4">
                <div class="container-xxl">
                                ...
                                <div class="card border-0 w280">
                                    <div class="card-body pb-0">
                                        <div class="d-flex py-1">
                                            <img class="avatar rounded-circle sm" src="<?=base_url('design/assets/images/profile_av.png');?>" alt="profile">
                    ...
                    <!-- main menu Search-->
                    <div class="order-0 col-lg-5 col-md-4 col-sm-12 col-12 mb-3 mb-md-0 ">
                        <h3>Project Management and Monitoring System</h3>
                    </div>
